      ...
      <div className="relative z-50 flex flex-col w-72 max-w-[85vw] h-full bg-white dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-800 shadow-2xl animate-in slide-in-from-left duration-200">
          ...
          {MAIN_NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.badge && (
                  <span className="text-[10px] px-1.5 py-0.5 rounded-md font-semibold bg-neutral-200 dark:bg-neutral-800">
                    {item.badge}
                  </span>
                )}
              </Link>
        ...
        <div className="p-4 border-t border-neutral-200 dark:border-neutral-800 space-y-3 bg-neutral-50/50 dark:bg-neutral-900/50">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-xs font-medium text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/30 hover:bg-rose-100 dark:hover:bg-rose-950/50 transition-colors cursor-pointer"
          >
